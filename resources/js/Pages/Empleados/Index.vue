<script setup lang="ts">
    ...
    // Importacion de props y logica de negocio
    ...
    const {
        ...
        // selects ya “labeled” y con Todos habilitado
        corporativosLabeled,
        sucursalesLabeled,
        areasLabeled,
        ...
        // combos modal (modal sí puede exigir corporativo/sucursal)
        modalCorporativos,
        modalSucursalesSafe,
        modalAreasSafe,
    ...
    const ICON_POWER = 'https://img.icons8.com/fluency-systems-regular/48/lightning-bolt.png'
</script>
    ...
    <AuthenticatedLayout>
        ...
        <div class="w-full max-w-full min-w-0 overflow-x-hidden">
            <div class="w-full max-w-full min-w-0 px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
                ...
                bg-white dark:bg-neutral-900 shadow-sm px-4 py-4">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center gap-2 min-w-0">
                        ...
                        bg-slate-50 dark:bg-neutral-950/40 px-3 py-2 min-w-0 max-w-full">
                            ...
                            <button type="button" @click="confirmBulkDeactivate"
                ...
                lg:grid-cols-12 gap-3 lg:items-end
                rounded-2xl border border-slate-200/70
                dark:border-white/10 bg-white
                dark:bg-neutral-900 shadow-sm p-4 max-w-full">
                    <!-- Corporativo -->
                    ...
                    <div class="lg:col-span-2 min-w-0">
                        ...
                        v-model="state.sucursal_id" :options="sucursalesLabeled"
                        label="Sucursal" label-key="__label"
                        value-key="id" :nullable="true"
                        null-label="Todas" placeholder="Todas"
                        class="w-full" :disabled="!canPickSucursalFilter"/>
                    </div>
                    ...
                    <div class="lg:col-span-2 min-w-0">
                        ...
                        v-model="state.area_id" :options="areasLabeled"
                        label="Área" label-key="__label" value-key="id"
                        :nullable="true" null-label="Todas"
                        placeholder="Todas" class="w-full"
                        :disabled="!canPickAreaFilter"
                        />
                    </div>

                    <div class="lg:col-span-2 min-w-0">
                        <AppSelect v-model="state.activo" label="Estatus" :disabled="!state.corporativo_id">
                    ...
                    <div class="lg:col-span-2 min-w-0">
                        <AppSelect v-model="state.perPage" label="Registros por página" :disabled="!state.corporativo_id">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-[1100px] text-sm">
                            ...
                            <tbody>
                                ...
                                dark:border-white/10 hover:bg-slate-50/70
                                dark:hover:bg-neutral-950/40 transition">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        border bg-slate-100 text-slate-700
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="flex justify-center gap-2">
                                            <button type="button"
                                                ...
                                                dark:bg-white dark:text-neutral-200 dark:border-white/10 dark:hover:bg-blue-400
                                                transition active:scale-[0.98]"
                                                title="Editar" aria-label="Editar">
                                                <img :src="ICON_EDIT" alt="Editar" class="h-5 w-5" />
                                            </button>

                                            <button v-if="row.activo"
                                                type="button"
                                                @click="confirmDeactivate(row)"
                                                class="inline-flex items-center justify-center rounded-xl p-2.5 border
                                                bg-white text-rose-700 border-rose-200 hover:bg-rose-50
                                                dark:bg-white dark:text-rose-300 dark:border-rose-500/20 dark:hover:bg-red-400
                                                transition active:scale-[0.98]"
                                                title="Dar de baja"
                                                aria-label="Dar de baja">
                                                <img :src="ICON_TRASH" alt="Baja" class="h-5 w-5" />
                                            </button>
                                            ...
                                            <button v-else type="button"
                                                ...
                                                dark:bg-white dark:text-emerald-300 dark:border-emerald-500/20
                ...
                <div class="lg:hidden grid gap-3 max-w-full">
                        ...
                        <div class="flex items-start gap-3 min-w-0">
                            ...
                            <div class="min-w-0 flex-1">
                                <div class="flex items-start justify-between gap-2 min-w-0">
                                    ...
                                    gap-2 rounded-full px-3 py-1 text-[11px]
                                ...
                                <div class="mt-4 flex flex-wrap gap-2">
                                    ...
                                    bg-white text-slate-700 border-slate-200 hover:bg-slate-50
                                    dark:bg-white dark:border-white/10 dark:hover:bg-white
                                    transition active:scale-[0.98]">
                                        <img :src="ICON_EDIT" alt="Editar" class="h-5 w-5" />
                                    </button>
                                    ...
                                    <button v-if="row.activo" type="button"
                                        ...
                                        border bg-white text-rose-700
                                        border-rose-200 hover:bg-rose-50
                                        dark:bg-neutral-900 dark:text-rose-300 dark:border-rose-500/20 dark:hover:bg-rose-500/10
                                        transition active:scale-[0.98]">
                                        <img :src="ICON_TRASH" alt="Eliminacion" class="h-5 w-5" />
                                    </button>

                                    <button v-else type="button"
                                        @click="confirmActivate(row)"
                                        class="inline-flex items-center gap-2
                                        rounded-xl px-3 py-2 text-xs font-semibold border bg-emerald-50 text-emerald-700 border-emerald-200 hover:bg-emerald-100
                    ...
                    <div class="rounded-2xl border border-slate-200/70
                        ...
                        <div class="flex flex-wrap gap-2 max-w-full">
                            <button v-for="(l, idx) in mobileLinks"
                                :key="idx" type="button" @click="goTo(l.url)"
                                :disabled="!l.url"
                                class="px-3 py-2 text-xs font-semibold rounded-xl
                                border max-w-full min-w-0
                    ...
                    <div class="p-4 sm:p-6 rounded-2xl
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="sm:col-span-2">
                                ...
                                label="Corporativo" label-key="__label"
                                value-key="id" :nullable="false"
                                placeholder="Selecciona corporativo..."
                                class="w-full" :error="errors.corporativo_id ?? null"/>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                class="w-full" :disabled="!form.corporativo_id"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                label="Área" label-key="__label"
                                value-key="id" :nullable="true"
                                null-label="Sin área" placeholder="Sin área"
                                class="w-full" :disabled="!form.corporativo_id"/>
                            </div>
                            ...
                            <!-- IMPORTANTE: estos deben ser STRING siempre (ya viene arreglado desde el hook) -->
                        ...
                        sm:items-center sm:justify-end gap-2">
                            ...
                            <button type="button" @click="submit"
                                ...
                                dark:bg-neutral-100 dark:text-neutral-900 dark:hover:bg-green-400
                                disabled:opacity-50 disabled:cursor-not-allowed
                                transition active:scale-[0.98]">
                                <img :src="saving ? ICON_POWER : ICON_CHECK" class="h-5 w-5 opacity-90" alt="" />
                            </button>
                        </div>
                    </div>
                </Modal>
