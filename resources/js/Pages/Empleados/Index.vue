<script setup lang="ts">
     ...
     * - Combobox buscable (reutilizable) para selects pesados
     * ======================================================
     */
    ...
    <AuthenticatedLayout>
        ...
        <div class="w-full max-w-full min-w-0 overflow-x-hidden">
            <div class="w-full max-w-full min-w-0 px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
                ...
                <!-- Corporativo (combobox buscable) -->
                <div class="lg:col-span-2 min-w-0">
                    <AppCombobox
                    :modelValue="state.corporativo_id || ''"
                    @update:modelValue="(v) => (state.corporativo_id = (v ?? '') as any)"
                ...
                <!-- Sucursal (combobox buscable, dependiente de corporativo) -->
                <div class="lg:col-span-2 min-w-0">
                    <AppCombobox
                    :modelValue="state.sucursal_id || ''"
                    @update:modelValue="(v) => (state.sucursal_id = (v ?? '') as any)"
                ...
                <!-- Área (combobox buscable, dependiente de corporativo) -->
                <div class="lg:col-span-2 min-w-0">
                    <AppCombobox
                    :modelValue="state.area_id || ''"
                    @update:modelValue="(v) => (state.area_id = (v ?? '') as any)"
                    :options="areasByCorp"
                    label="Área"
                    placeholder="Todas"
        ...
        <!-- ======================================================
            MODAL Create/Edit (NO EXCEDE PANTALLA + SCROLL)
            ====================================================== -->
                    ...
                    <div :class="modalPanel">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <AppCombobox
                                ...
                                @update:modelValue="(v) => (form.corporativo_id = (v ?? '') as any)"
                                :options="corporativosActive"
                                label="Corporativo"
                                placeholder="Todos"
                                searchPlaceholder="Buscar corporativo..."
                            ...
                            <!-- Sucursal (combobox requerido) -->
                            <div class="sm:col-span-2">
                            <AppCombobox
                                :modelValue="form.sucursal_id || ''"
                                @update:modelValue="(v) => (form.sucursal_id = (v ?? '') as any)"
                            ...
                            <AppCombobox
                                ...
                                @update:modelValue="(v) => (form.area_id = (v ?? '') as any)"
                                :options="modalAreas"
                                label="Área"
