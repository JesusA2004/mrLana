...
/**
 * Empleados/Index.vue
 * - Archivo “template-first” (poca lógica aquí)
 * - “Todos” disponible en Corporativo / Sucursal / Área (SOLO INDEX)
 * - Sucursal/Área deshabilitadas si no hay corporativo
 */
  ...
  <AuthenticatedLayout>
    ...
    <div class="w-full max-w-full min-w-0 overflow-x-hidden">
      <div class="w-full max-w-full min-w-0 px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        >
          <!-- Corporativo (INDEX: permite “Todos”) -->
          ...
          <div class="lg:col-span-12 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            <button
              ...
              class="inline-flex items-center justify-center rounded-xl px-4 py-2 text-xs font-semibold
                     bg-slate-100 text-slate-800 hover:bg-slate-200 disabled:opacity-50 disabled:cursor-not-allowed
                    ...
                    <div class="flex justify-center gap-2">
                      <button
                        ...
                        class="inline-flex items-center justify-center rounded-xl p-2.5 border
                               ...
                               dark:bg-neutral-900 dark:text-neutral-200 dark:border-white/10 dark:hover:bg-neutral-950/40
                               transition active:scale-[0.98]"
                        title="Editar"
                        aria-label="Editar"
                      >
        ...
        <!-- Modal Create/Edit (aquí NO tocamos tu regla: create/edit como ya lo tienes “bien”) -->
        <Modal :show="modalOpen" @close="closeModal">
          ...
          >
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <!-- IMPORTANT: estos deben ser STRING siempre (ya viene arreglado desde el hook) -->
