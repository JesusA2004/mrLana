...
import SearchSelect from '@/Components/ui/SearchableSelect.vue' // <- el componente que me diste
...
<template>
  ...
  <AuthenticatedLayout>
    ...
    <div class="w-full max-w-full min-w-0 px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
      ...
      <!-- FILTROS -->
      <div
        class="mb-4 rounded-3xl border border-slate-200/70
      ...
      >
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-3">
          ...
          <div v-if="isPrivileged" class="lg:col-span-3 min-w-0">
            ...
            <select v-model="state.status" class="w-full rounded-2xl mt-1" :class="selectBase">
          ...
          <div class="lg:col-span-12 flex flex-wrap items-center gap-3 pt-2">
            ...
            <div class="ml-auto flex flex-wrap items-center gap-2">
              ...
              <button
                v-if="selectedActiveCount > 0 && !selectedHasInactive"
                type="button"
      ...
      <!-- TABLA (lg+) -->
      <div
        class="hidden lg:block rounded-3xl border border-slate-200/70
               dark:border-white/10 bg-white/90 dark:bg-neutral-900/80
