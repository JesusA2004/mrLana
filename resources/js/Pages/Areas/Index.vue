<script setup lang="ts">
    ...
    const {
        ...
        // Corporativos (listas activas para SearchableSelect)
        corporativosActive,
    ...
    /** Agrupa por corporativo (solo pagina actual) */
                ...
                <div class="mb-4 grid grid-cols-1 lg:grid-cols-12 gap-3
                    ...
                    <div class="lg:col-span-3 min-w-0">
                        <SearchableSelect
                            ...
                            label="Corporativo"
                            placeholder="Todos"
                            searchPlaceholder="Buscar corporativo por nombre o codigo..."
                            :allowNull="true"
                            nullLabel="Todos"
                            rounded="xl"
                            zIndexClass="z-40"
            ...
            <div class="rounded-3xl border border-slate-200/60 dark:border-white/10 bg-white dark:bg-neutral-900 shadow-2xl">
                <div class="p-6 sm:p-7">
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <!-- Botón X (no lo quites; estilo y hover respetados por patrón) -->
                        <button
                            type="button"
