...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="w-full max-w-full min-w-0 px-3 sm:px-6 lg:px-8 py-4 sm:py-6">
            ...
            dark:border-white/10 bg-white/90 dark:bg-neutral-900/80 backdrop-blur
            shadow-sm overflow-visible">
                <table class="w-full table-auto text-sm">
                    ...
                    <tbody>
                        ...
                        dark:hover:bg-neutral-950/40 transition">
                            ...
                            <td class="px-4 py-3">
                                <span class="inline-flex items-center rounded-full px-3
                                py-1 text-xs font-semibold border border-slate-200
                                bg-slate-50 text-slate-700 dark:border-white/10
                                dark:bg-neutral-950/40 dark:text-neutral-100">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-right">
                                <div class="inline-flex gap-2">
                                    ...
                                    <button v-if="canPay" @click="goPay(row.id)" type="button" class="btn bg-sky-600 text-white
                                    hover:bg-sky-700 dark:bg-sky-500
                                    ...
                                    <button v-if="canDelete && !isColaborador"
                                    @click="destroyRow(row)" type="button"
                ...
                px-4 py-3 bg-white/90 dark:bg-neutral-900/80">
                    ...
                    <nav class="flex flex-wrap gap-2 max-w-full">
                        ...
                        @click="link.url ? goTo(link.url) : null" :disabled="!link.url"
                        ...
                        :class="link.active ? 'ring-2 ring-slate-300 dark:ring-white/10' : ''" v-html="link.label" />
                    </nav>
                </div>
            </div>
                ...
                <transition-group name="list" tag="div" class="grid gap-3">
                    ...
                    backdrop-blur shadow-sm p-4">
                            ...
                            <div class="flex items-start gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <div class="flex items-center gap-2 min-w-0">
                                        ...
                                        shrink-0 border-slate-200 bg-slate-50
                        ...
                        <div class="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs text-slate-700 dark:text-neutral-200">
                            ...
                            dark:border-white/10 bg-slate-50/80 dark:bg-neutral-950/40 p-3">
                        ...
                        <div class="mt-4 grid grid-cols-2 gap-2">
                            ...
                            <button v-if="canUploadComprobantes"
                            @click="goComprobar(row.id)" type="button"
