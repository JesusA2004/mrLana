 ...
 * ----------------------------------------------------------
 * - Responsive OK
 * - Filtros OK (Todos / Activos / Inactivos)
 * - Paginación OK
 * ==========================================================
 */
        ...
        >
          ...
          >
            <div class="text-xs text-slate-600 dark:text-neutral-300">
              Página <span class="font-semibold">{{ props.conceptos.current_page }}</span> de
            ...
            <div class="flex items-start justify-between gap-3 min-w-0">
              <div class="flex items-start gap-3 min-w-0">
                ...
                <div class="min-w-0">
                  ...
                  <div class="mt-0.5 text-xs text-slate-500 dark:text-neutral-400 break-all">
                    ID: <span class="font-semibold">{{ row.id }}</span>
                  </div>
                </div>
              </div>
          ...
          >
            <div class="flex items-center justify-between mb-3 gap-2 min-w-0">
              <div class="text-xs text-slate-600 dark:text-neutral-300 min-w-0 truncate">
                <span class="font-semibold">{{ props.conceptos.from ?? 0 }}</span> -
                <span class="font-semibold">{{ props.conceptos.to ?? 0 }}</span> /
                <span class="font-semibold">{{ props.conceptos.total }}</span>
              </div>
      ...
      <div class="rounded-3xl border border-slate-200/60 dark:border-white/10 bg-white dark:bg-neutral-900 shadow-2xl">
        <div class="p-6 sm:p-7">
          ...
          <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 min-w-0">
            ...
            <div class="sm:col-span-2 flex items-center gap-3 pt-1 min-w-0">
              <input
                id="c-activo"
                type="checkbox"
                v-model="form.activo"
