...
<template>
  <nav
    class="h-16 border-b backdrop-blur flex items-center justify-between px-4 sm:px-6 lg:px-8
  ...
  >
    ...
    <div class="flex items-center gap-3">
      ...
      <button
        type="button"
        @click="toggle"
        class="relative inline-flex h-9 w-16 items-center rounded-full border
               bg-slate-100/80 border-slate-300/80 shadow-sm
      ...
      >
        <span
          class="inline-flex h-7 w-7 items-center justify-center rounded-full shadow
