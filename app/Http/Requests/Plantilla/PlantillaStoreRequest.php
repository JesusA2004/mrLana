...
/**
 * Valida la creación de una plantilla. La plantilla se guarda siempre como BORRADOR.
 * El usuario es quien crea la plantilla, por lo que no se valida user_id desde el cliente.
 */
